...
- lustre, lustre_dev_tools, and (optionally) sketch are installed
  ```
  gleam add lustre sketch sketch_lustre
  gleam add --dev lustre_dev_tools
  ```
- the open-props css files are available for your build system. In this example, see the tools.lustre.html section of [./gleam.toml](./gleam.toml) but you can also install them in the various other ways opne-props allows depending on your setup.
